  ...
  const events = [
    {
      ...
      attendees: 150,
      rsvp: false,
      description: "Meet employers from tech, finance, and healthcare industries. Bring your resume and dress professionally.",
    ...
    },
    {
      ...
      attendees: 12,
      rsvp: true,
      description: "Weekly calculus problem solving session. All skill levels welcome.",
    ...
    },
    {
      ...
      attendees: 500,
      rsvp: false,
      description: "Food trucks, live music, and games. Free admission for all students.",
    ...
    },
    {
      ...
      attendees: 75,
      rsvp: true,
      description: "Student research presentations across all departments. Open to all majors.",
    ...
    },
    {
      ...
      attendees: 25,
      rsvp: false,
      description: "Weekly meeting to discuss upcoming photo walks and exhibitions.",
